...
def objective_function_scores_hybrid_1(self, optuna_trial):

    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, slim, bpr, slim, slim, slim)
...
def objective_function_scores_hybrid_2(self, optuna_trial):
    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, slim, user, slim, slim, slim)
...
def objective_function_scores_hybrid_3(self, optuna_trial):
    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, rp3, slim, slim, slim, slim)
...
def objective_function_scores_hybrid_4(self, optuna_trial):
    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, slim, hyb, slim, slim, slim)
...
def objective_function_scores_hybrid_5(self, optuna_trial):
    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, slim, item, slim, slim, slim)
...
def objective_function_scores_hybrid_6(self, optuna_trial):
    # bpr = SLIM_BPR_Cython(self.URM_train)
    # bpr.load_model(folder_path="_saved_models", file_name="SLIM_BPR_Recommender_train")
    recom1 = ScoresHybridRecommender(self.URM_train, slim, items, slim, slim, slim)
