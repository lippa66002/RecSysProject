...
optuna_params = controller.optunizer(ModelName.MultVAERecommender_PyTorch)

recommender_instance = controller.generate_model(ModelName.MultVAERecommender_PyTorch, optuna_params)
